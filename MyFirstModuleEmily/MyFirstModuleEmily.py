...
class MyFirstModuleEmily(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "Center of Mass" # TODO make this more human readable by adding spaces
...
#
# MyFirstModuleEmilyWidget
#

class MyFirstModuleEmilyWidget(ScriptedLoadableModuleWidget):
...
class MyFirstModuleEmilyLogic(ScriptedLoadableModuleLogic):
...
class MyFirstModuleEmilyTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_MyFirstModuleEmily1()

  def test_MyFirstModuleEmily1(self):
